...
- (id)init
{
    if (self = [super init]) {
        ...
        [[ECPurchase shared] setProductDelegate:(id)self];
        [[ECPurchase shared] setTransactionDelegate:(id)self];
        [[ECPurchase shared] setVerifyRecepitMode:ECVerifyRecepitModeNone];
    }
    return self;
}
